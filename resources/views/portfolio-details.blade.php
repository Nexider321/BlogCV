                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item"><a href="index.blade.php#blog">Blog</a>
                                    <ul class="sub-menu pb-10 pt-10 pl-15 pr-15">
                                        ...
                                        <li><a href="news-details.blade.php">News Details</a></li>
                                    </ul>
                                </li>
                ...
                <div class="col-xl-12">
                    <div class="news-details">
                        <div class="news-details-img mb-30">
                            <img src="assets/img/projects/project-details.jpg" alt="news details 1">
                        </div>
                        ...
                        <div class="project-gallery mb-100 mt-30">
                            <div class="row">
                                <div class="col-xl-7 col-lg-7">
                                    <img class="mb-30" src="assets/img/projects/pdet-1.jpg" alt="pdet1">
                                    <img class="mb-30" src="assets/img/projects/pdet-3.jpg" alt="pdet2">
                                </div>

                                <div class="col-xl-5 col-lg-5">
                                    <img class="mb-30" src="assets/img/projects/pdet-2.jpg" alt="pdet3">
                                    <img class="mb-30" src="assets/img/projects/pdet-4.jpg" alt="pdet-4">
                                </div>
                            </div>
                        </div>
